...
1. Burn the OS Image of your choice to an SD Card (All Pi's) and/or load it onto an NVMe SSD if you are installing one (QBOX4/5 only). If you are unfamiliar with this preocess a useful Guide is here.
